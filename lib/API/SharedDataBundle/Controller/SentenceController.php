...
use API\SharedDataBundle\Entity\Sentence;
...
class SentenceController extends MasterSecurityController implements AdminAuthInterface
{
    public function createAction(Request $request)
    {
        ...
        $response = $this->get('api.shared.manual_validator')->validate($sentence);
    ...
    {
        return $this->get('api.shared.sentence_repository')
    ...
    {
        return $this->get('api.shared.sentence_repository')->updateLessonSentence(array(
