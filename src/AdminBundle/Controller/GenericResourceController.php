...
class GenericResourceController extends ResourceController
{
        ...
        if ($configuration->isHtmlRequest()) {
            $view
                ...
                ->setData([
                    ...
                    'listing_title' => $this->getListingTitle(),
                    'template' => sprintf('/%s/index.html.twig', $this->getName()),
                ])
            ;
        }
    ...
    public function createAction(Request $request)
    {
        ...
        if ($request->isMethod('POST') && $form->handleRequest($request)->isValid()) {
            ...
            $this->addFlash(
                'notice',
                sprintf('%s created successfully', $this->getName())
            );
        ...
        $view = View::create()
            ->setData([
                ...
                'listing_title' => $this->getListingTitle(),
                'template' => sprintf('/%s/create.html.twig', $this->getName()),
            ])
    ...
    public function updateAction(Request $request)
    {
        ...
        $view = View::create()
            ->setData([
                ...
                'form' => $form->createView(),
                'listing_title' => $this->getListingTitle(),
                'template' => sprintf('/%s/update.html.twig', $this->getName()),
            ])
