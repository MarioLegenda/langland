        ...
        controller: [
            ...
            $scope.thisClass.createLesson = function() {
                ...
                Server.communicate('lesson.create', {
                    'class': $scope.thisClass.class.class_id,
                ...
                $scope.sentence = {
                    ...
                    create: function() {
                        ...
                        Server.communicate('sentence.create', {
                            ...
                            translations: GenericDomHelper.extractCourseTranslations($('.collapseable-fields .translation')),
                            ...
                            if (d.status === 'success') {
                                ...
                                GenericDomHelper.resetCourseTranslations($('.collapseable-fields .translation'));
                                findInternalNames();
            ...
            function Path() {
                ...
                var namespaces = {
                    language: {
                        ...
                        get_all: 'admin/language/get-all-languages',
                        update_working_language: 'admin/language/update-working-language'
                    },
                    category: {
                        create: 'admin/category/create',
                        get_all: 'admin/category/get-all-categories'
                    },
                    word: {
                                ...
                                'RouteHelper', function(
                                    ...
                                    $scope.createCategory = function($event) {
                                        ...
                                        Server.communicate('category.create', {
                                            ...
                                            language: LanguageProvider.getLanguage().value
                                        }).then(function(data) {
                                            $scope.loading = false;
        ...
        return {
            ...
            controller: [
                ...
                'LanguageProvider', function(
                    ...
                    Server.communicate('category.get_all', { language_id: LanguageProvider.getLanguage().value })
                        .then(function(data) {
            ...
            controller: [
                ...
                'RouteHelper', function(
                    ...
                    if (LanguageProvider.getLanguage().value !== null) {
                        ...
                        findLastWords({
                            language: (LanguageProvider.getLanguage().value === null) ? '' : LanguageProvider.getLanguage().value,
...
(function () {
    ...
    app.controller('AppController', [
        ...
        $rootScope.$on('action.load_course', function(event, data) {
            $location.url('/admin/course/' + data.id);
        });
    ...
    app.controller('MainPageController', [
        ...
        function(
            ...
            Server.communicate('language.get_all', {}).then(function(data) {
                var languages = data.data.data,
                    parsedLanguages = [],
                    i,
                    appLanguages,
                    languageSelected,
